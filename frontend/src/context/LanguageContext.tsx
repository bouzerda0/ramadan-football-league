...
const translations = {
  ...
  'hero.subtitle': { ar: 'زون 01 وجدة • بطولة المدرسة 2026', fr: 'Zone 0 • Tournoi Scolaire 2026', en: 'Zone 0 • School Tournament 2026' },
  'hero.cta': { ar: 'عرض الجدول', fr: 'Voir Calendrier', en: 'View Schedule' },
  'hero.meta': { ar: ' فرق • دور المجموعات → خروج المغلوب • مباريات ما بعد الإفطار', fr: ' équipes • Groupes → Élimination • Matchs post-Iftar', en: 'All teams • Group stage → Knockout • Post-Iftar matches' },
  ...
  'gallery.subtitle': { ar: 'أبرز ما بعد المباراة من زون 01 وجدة', fr: 'Moments post-match de Zone 0', en: 'Post-match highlights from Zone 0' },
  ...
  'register.subtitle': { ar: '6 فرق • بطل واحد • مباريات ما بعد الإفطار', fr: '6 équipes • 1 champion • Matchs post-Iftar', en: 'All teams • 1 champion • Post-Iftar matches' },
  ...
  'footer.rights': { ar: '© 2026 زون 01 وجدة. جميع الحقوق محفوظة.', fr: '© 2026 Zone 0. Tous droits réservés.', en: '© 2026 Zone 0. All rights reserved.' },
