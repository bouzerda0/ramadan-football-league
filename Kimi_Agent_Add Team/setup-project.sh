...
# Zone 01 Oujda Football League - Project Setup Script
# Run this script to create the project structure

PROJECT_NAME="zone01-football"
...
echo "Created tsconfig.app.json"
...
<html lang="en">
  <head>
    ...
    <title>Zone 01 Oujda Ramadan Football League 2026</title>
  </head>
  <body>
    <div id="root"></div>
...
echo "2. npm install"
echo "3. Copy the source files from src/"
echo "4. npm run dev"
