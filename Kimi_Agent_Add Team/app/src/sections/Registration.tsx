...
import { Trophy, Users, Mail, MapPin, Phone, ExternalLink, Download, Send } from 'lucide-react';
    ...
    >
      ...
      <div className="relative z-10 section-padding">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Footer */}
          <footer 
            className={`border-t border-[#D4A018]/20 pt-12 transition-all duration-700 delay-200 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
